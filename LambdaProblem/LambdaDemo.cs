...
namespace LambdaProblem
{
    internal class LambdaDemo
    {
        ...
        public static void AddRecords(List<Person> listPersonInCity)
        {
            ...
            listPersonInCity.Add(new Person("203456877", "Raj", "13 Main Ct, Newyork,NY", 25));
            ...
            listPersonInCity.Add(new Person("203456880", "Raj", "345 Main Ave, Dayton,OH", 55));
            ...
            listPersonInCity.Add(new Person("203456884", "Raj", "126 Province Ave, Baltimore,NY", 95));
        ...
        {
            if (listPersonInCity.Exists(e => e.Name == "Raj"))
            {
                Console.WriteLine("Yes, A person having name \"Raj\" exists in our list");
            }
        }
    }
}
